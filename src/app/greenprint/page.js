...
export default function Greenprint() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-emerald-950/30 to-[#0a0a0a] text-white relative">
      <div className="absolute inset-0 bg-grid-pattern opacity-30"></div>
      
      {/* Top Navigation */}
      <nav className="fixed w-full bg-black/50 backdrop-blur-sm border-b border-gray-800 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link href="/#greenprint" className="text-gray-300 hover:text-white transition-colors">Greenprint</Link>
      ...
      <div className="flex min-h-screen pt-20">
        {/* Left Sidebar */}
        <div className="w-64 fixed h-[calc(100vh-5rem)] overflow-y-auto bg-black/30 border-r border-gray-800">
          <div className="p-6">
            <nav className="space-y-6">
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="#introduction" className="text-gray-300 hover:text-white block py-1">
                      Introduction
                    </Link>
                  </li>
                  <li>
                    <Link href="#getting-started" className="text-gray-300 hover:text-white block py-1">
                      Getting Started
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                <h3 className="text-sm font-semibold text-emerald-400 uppercase tracking-wider mb-3">Products</h3>
                <ul className="space-y-2">
                  <li>
                    <Link href="#funding-bot" className="text-gray-300 hover:text-white block py-1">
                      Funding Bot
                    </Link>
                  </li>
                  <li>
                    <Link href="#clmm-bot" className="text-gray-300 hover:text-white block py-1">
                      CLMM Bot
                    </Link>
                  </li>
                  <li>
                    <Link href="#data-analysis" className="text-gray-300 hover:text-white block py-1">
                      Data Analysis Tool
                    </Link>
                  </li>
                </ul>
