...
export default function Greenprint() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-primary-light/10 to-black text-white relative">
      <div className="absolute inset-0 bg-grid-pattern opacity-30"></div>
      
      {/* Fixed Sidebar */}
      <div className="fixed left-0 top-0 h-full w-64 bg-black/50 backdrop-blur-sm border-r border-gray-800 z-50 overflow-y-auto">
        <div className="p-6">
          ...
          <nav className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Products</h3>
              <ul className="space-y-2">
                <li>
      ...
      <div className="pl-64 relative z-10">
        {/* Top Navigation */}
        <nav className="sticky top-0 bg-black/50 backdrop-blur-sm border-b border-gray-800 z-40">
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-semibold">Greenprint Documentation</h1>
